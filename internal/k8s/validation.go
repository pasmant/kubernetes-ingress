...
const (
    ...
    appProtectDosSecurityLogEnableAnnotation = "appprotect.f5.com/app-protect-dos-security-log-enable"
    appProtectDosMonitorAnnotation           = "appprotect.f5.com/app-protect-dos-appProtectDosMonitorAnnotation"
