...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Bados) DeepCopyInto(out *Bados) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Bados.
func (in *Bados) DeepCopy() *Bados {
	if in == nil {
		return nil
	}
	out := new(Bados)
